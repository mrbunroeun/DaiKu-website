    ...
    <div
        ...
        <div class="absolute inset-0 flex justify-center items-start z-20">
            ...
            <div class="w-full max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 text-center text-white lg:pt-[280px]">
                ...
                <h1 class="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl​​ lg:mt-[0rem] sm:mt-[8rem] mt-[5rem] font-bold leading-tight">
...
========================================================= --}}
    ...
    <div class="relative w-full" id="project">
        ...
        <div class="flex flex-wrap gap-2 justify-center md:justify-end px-4 md:px-12">
            <button
                class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200 active"
                data-filter="all">All</button>
            <button
                class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200"
    ...
    <div class="relative w-full mt-0">
        <div class="relative w-full overflow-hidden">
            ...
            <div class="absolute inset-0 bg-[#F26A27] z-0" style="clip-path:polygon(0 18%,100% 4%,100% 100%,0 100%);">
            </div>
