...
@keyframes scrollleft {
    from { left: 100%; }
    to   { left: calc((var(--item-width) + var(--item-gap)) * -1 * var(--total-items)); }
}
:root {
    --item-width: 160px;
    --total-items: 8;
...
.item1 { animation-delay: calc(var(--duration) / var(--total-items) * -7); }
.item2 { animation-delay: calc(var(--duration) / var(--total-items) * -6); }
.item3 { animation-delay: calc(var(--duration) / var(--total-items) * -5); }
.item4 { animation-delay: calc(var(--duration) / var(--total-items) * -4); }
.item5 { animation-delay: calc(var(--duration) / var(--total-items) * -3); }
.item6 { animation-delay: calc(var(--duration) / var(--total-items) * -2); }
.item7 { animation-delay: calc(var(--duration) / var(--total-items) * -1); }
...
@section('content')
{{-- =========================================================
     MOBILE / TABLET VERSION (shown below lg breakpoint)
========================================================= --}}
<div class="relative hidden lg:block -mt-[272px] xl:h-auto 2xl:h-auto bg-[#F26A27] z-50"
     style="clip-path: polygon(35% 12%, 100% 0, 100% 78%, 0 100%, 0 0);">
    {{-- Line decoration: visible on all desktop sizes now --}}
    <img src="{{ asset('assets/images/line_style.png') }}" alt=""
        class=" w-full  -inset-4
               "
        data-aos="fade-up" data-aos-duration="1000">

    {{-- Content --}}
    <div id="company_background_desktop"
        class="relative w-full -mt-10
               lg:max-w-3xl xl:max-w-4xl
               mx-auto
               lg:pt-16 xl:pt-20 2xl:pt-8
               text-white text-center">

        {{-- Title --}}
        <div>  <h1 class="absolute lg:text-[68px] xl:text-[32px]
                   font-[100] leading-tight w-full -inset-6"
...
<div class="relative w-full">
    ...
    $services = [
        [
            ...
            'desc'  => 'Professional mechanical engineering services including HVAC systems, air conditioning solutions, ventilation systems, ducting works, chilled water systems, and preventive maintenance programs that improve building performance, energy efficiency, and occupant comfort.',
        ...
        [
            ...
            'desc'  => 'Professional electrical engineering services covering power distribution, lighting systems, electrical installations, testing, commissioning, and maintenance for safe and reliable building operations.',
        ...
        [
            ...
            'desc'  => 'Integrated plumbing and fire protection solutions for commercial, industrial, and residential developments, ensuring reliable water management, efficient drainage, and advanced fire safety systems that meet operational and regulatory requirements.',
        ...
        [
            ...
            'desc'  => 'Expert MEP planning, engineering design, technical consultancy, and project management services to optimize building performance, efficiency, and long-term operational reliability.',
        ...
        [
            ...
            'desc'  => 'Preventive air conditioning maintenance solutions including system inspection, cleaning, performance optimization, and annual service contracts designed to improve efficiency, reduce downtime, and extend equipment lifespan.',
    ...
    <div class="py-4 px-3 max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($services as $index => $service)
         <div class="rounded-md overflow-hidden flex flex-col shadow-md bg-[#2C3E50]"
             data-aos="fade-up"
...
<div class="w-full max-w-5xl mx-auto px-4 mt-10 mb-16 text-center" data-aos="fade-up">
    <h2 class="text-xl sm:text-2xl md:text-[26px] font-bold mb-10 text-[#F26A27]">
        Industries We Serve
    </h2>
    ...
    $industries = [
        ...
        ['title'=>'Commercial','desc'=>'Hotels, Resorts, Serviced Apartments','icon'=>'assets/images/Serve/Frame2.png'],
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-5">
        ...
        <div class="rounded-md p-5 sm:p-6 flex flex-col items-center justify-center border border-[#F26A27]">
            <img src="{{ asset($industry['icon']) }}" alt="{{ $industry['title'] }}"
                 class="w-8 h-8 sm:w-10 sm:h-10 mb-3">
            <h3 class="text-xs sm:text-sm font-bold mb-1 text-[#F26A27]">{{ $industry['title'] }}</h3>
            <p class="text-xs leading-snug text-[#374151]">{{ $industry['desc'] }}</p>
        </div>
        @endforeach
    </div>
</div>
...
<div class="relative w-full" id="project">
    ...
    <div class="flex flex-wrap gap-2 justify-center md:justify-end px-4 md:px-12">
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200 active" data-filter="all">All</button>
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200" data-filter="resort">Resort</button>
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200" data-filter="hotel">Hotel</button>
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200" data-filter="polyclinic">Polyclinic</button>
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200" data-filter="residence">Residence & Villa</button>
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200" data-filter="aeon">Stores</button>
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200" data-filter="mall">Mall</button>
        <button class="filter-btn inline-flex items-center justify-center border border-[#F26A27] h-8 px-4 rounded-full cursor-pointer whitespace-nowrap text-[13px] [&.active]:bg-[#F26A27] [&.active]:text-white hover:bg-[#F26A27] hover:text-white transition-colors duration-200" data-filter="restaurant">Restaurant</button>
    </div>

    @php
    $projects = [
        ['slide'=>'item1','cat'=>'hotel','img'=>'assets/images/DaikuMEP/01.Sofitel/01.png','label'=>'Hotel','title'=>'Sofitel Phnom Penh Phokeethra - 5 Stars Luxury Hotel','loc'=>'Phnom Penh, Cambodia'],
        ['slide'=>'item2','cat'=>'resort','img'=>'assets/images/DaikuMEP/2.SiemPang/01.png','label'=>'Resort','title'=>'Siem Pang Resort','loc'=>'Stung Treng Province, Cambodia'],
        ['slide'=>'item3','cat'=>'polyclinic','img'=>'assets/images/DaikuMEP/06.ChendaolyClinic/01.jpg','label'=>'Polyclinic','title'=>'Chenda Polyclinic','loc'=>'Phnom Penh, Cambodia'],
        ['slide'=>'item4','cat'=>'resort','img'=>'assets/images/photo/Frame10.png','label'=>'Resort','title'=>'Koh Tang Resort','loc'=>'Sihanoukville, Cambodia'],
        ['slide'=>'item5','cat'=>'residence','img'=>'assets/images/DaikuMEP/08.VillaYimsResedence/01.png','label'=>'Residence','title'=>"Yim's Residence",'loc'=>'Phnom Penh, Cambodia'],
        ['slide'=>'item6','cat'=>'residence','img'=>'assets/images/DaikuMEP/09.VillaSiemReap/01.jpg','label'=>'Villa','title'=>'Villa Siem Reap','loc'=>'Siem Reap, Cambodia'],
        ['slide'=>'item7','cat'=>'aeon','img'=>'assets/images/DaikuMEP/10.CPS(AEONMALL3)/01.png','label'=>'Fashion Store','title'=>'CPS Aeon Mall Mean Chey','loc'=>'Phnom Penh, Cambodia'],
        ['slide'=>'item8','cat'=>'resort','img'=>'assets/images/DaikuMEP/20.OsoumResort/01.png','label'=>'Resort','title'=>'Samanea Wellness Resort','loc'=>'Kep, Cambodia'],
        ['slide'=>'item9','cat'=>'mall','img'=>'assets/images/DaikuMEP/AeonMallMeanchey/01.jpg','label'=>'Aeon Mall','title'=>'Aeon Mall Mean Chey','loc'=>'Phnom Penh, Cambodia'],
        ['slide'=>'item10','cat'=>'restaurant','img'=>'assets/images/photo/image.png','label'=>'Restaurant','title'=>'Kobe Teppanyaki Restaurant Koh Pich','loc'=>'Phnom Penh, Cambodia'],
    ];
    @endphp
...
<div class="relative w-full mt-0">
    ...
    <div class="absolute inset-0 bg-[#F26A27] z-0"
         style="clip-path:polygon(0 18%,100% 4%,100% 100%,0 100%);">
    </div>
        <div class="absolute top-0 left-0 w-full h-full bg-[#1F2D3D] z-[1]"
             style="clip-path:polygon(0 14%,100% 0%,100% 4%,0 18%);">
        </div>
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto
            ...
            <div class="w-full md:w-[40%] flex justify-center md:justify-start">
                <img src="{{ asset('assets/images/whychoos-us/Frame.png') }}"
            ...
            <div class="w-full md:w-[60%]">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-6">
                    <div>
                        ...
                        class="inline-block mt-6 px-5 py-3 text-xs sm:text-sm font-bold rounded bg-[#1F2D3D] text-white">
...
<div class="relative w-full h-auto min-h-[420px] sm:min-h-[520px] md:h-[600px] overflow-hidden">
    ...
    <div class="relative z-10 h-full flex flex-col justify-center items-center md:items-start text-center md:text-left px-6 md:px-0 py-16">
        <div class="w-full max-w-2xl mx-auto md:mx-0 md:ml-[8%] lg:ml-[12%]">

            <h2 class="text-2xl sm:text-3xl md:text-[36px] font-bold mb-2 text-[#F26A27]">
                Insights & Resources
            </h2>
            ...
            <a href="{{ route('insights') }}"
               class="inline-block text-sm font-semibold px-8 py-3 rounded transition bg-[#F26A27] text-white">
                View All Articles
            </a>
...
<section id="notable_clients" class="py-8">
    ...
    <div class="wrapper w-full max-w-7xl mx-auto relative h-[100px] sm:h-[140px] mt-8 overflow-hidden">
        <div class="item item1 bg-contain bg-center bg-no-repeat" style="background-image:url('assets/images/client/client-15new.png')"></div>
        <div class="item item2 bg-contain bg-center bg-no-repeat" style="background-image:url('assets/images/client/2.png')"></div>
        <div class="item item3 bg-contain bg-center bg-no-repeat" style="background-image:url('assets/images/client/3.png')"></div>
        <div class="item item4 bg-contain bg-center bg-no-repeat" style="background-image:url('assets/images/client/4.jpg')"></div>
        <div class="item item5 bg-contain bg-center bg-no-repeat" style="background-image:url('https://www.samanea-resort.com/wp-content/uploads/2025/02/Normal.png')"></div>
        <div class="item item6 bg-contain bg-center bg-no-repeat" style="background-image:url('assets/images/client/6.jpg')"></div>
        <div class="item item7 bg-contain bg-center bg-no-repeat" style="background-image:url('assets/images/client/7.jpg')"></div>
        <div class="item item8 bg-contain bg-center bg-no-repeat" style="background-image:url('assets/images/client/8.jpg')"></div>
    </div>
</section>
...
<section class="bg-white py-16 px-4 md:px-6 border-b border-slate-200" id="faqs-section">
    <div class="max-w-4xl mx-auto">
        ...
        @php
        $faqs = [
            ['q'=>'What services does Daiku provide?','a'=>'Daiku provides HVAC, Electrical, Plumbing, Fire Protection, MEP Design & Consultancy, and Air Conditioning Annual Maintenance Services.'],
            ['q'=>'Which industries do you serve?','a'=>'We support hospitality, healthcare, retail, commercial, residential, and industrial sectors.'],
            ['q'=>'Do you provide annual maintenance contracts?','a'=>'Yes. We offer customized annual maintenance programs for residential, commercial, and industrial facilities.'],
            ['q'=>'Can Daiku handle both installation and maintenance?','a'=>'Yes. We provide complete solutions from design and installation to ongoing maintenance and technical support.'],
        ];
        @endphp
        ...
        <div class="flex flex-col md:flex-row gap-4 items-start">
            <div class="flex flex-col gap-4 w-full md:w-1/2">
                ...
                <div class="border border-orange-400 rounded-xl overflow-hidden">
                    <button type="button" onclick="toggleFaq({{ $id }})" id="faq-btn-{{ $id }}"
                        ...
                        <span class="flex-shrink-0">
                            <svg id="faq-arrow-{{ $id }}" xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 viewBox="0 0 16 16"><polygon points="12,8 4,2 4,14"/></svg>
                        </span>
                    </button>
                    <div id="faq-answer-{{ $id }}" class="hidden bg-[#1e2a44] text-white border-t border-orange-300">
                        <div class="px-5 py-4 text-sm leading-relaxed text-slate-200 font-medium">{{ $faq['a'] }}</div>
                    </div>
                </div>
                @endforeach
            </div>
...
<div class="relative w-full bg-[#f8f7f7] my-12 sm:my-16 overflow-hidden">
    <div class="relative w-full h-[320px] sm:h-[380px] md:h-[460px] bg-cover bg-center"
        ...
        <div class="relative z-20 w-full h-full max-w-5xl mx-auto px-6
